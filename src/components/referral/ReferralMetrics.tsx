    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        <div className="flex items-center justify-center w-12 h-12 bg-purple-100 rounded-xl dark:bg-purple-900/30">
          <span className="text-purple-600 size-6 dark:text-purple-400 text-center" >₹</span>
        </div>
        <div className="flex items-end justify-between mt-5">
          <div>
            <span className="text-sm text-gray-500 dark:text-gray-400">Commissions</span>
            <h4 className="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">{data?.pending_commissions}</h4>
          </div>
          {/* <Badge color="success">
            <ArrowUpIcon />
            22.1%
